...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.signalPlot = QwtPlot(self.centralwidget)
        self.signalPlot.setObjectName(_fromUtf8("signalPlot"))
        self.horizontalLayout_3.addWidget(self.signalPlot)
        self.fftPlot = QwtPlot(self.centralwidget)
        self.fftPlot.setObjectName(_fromUtf8("fftPlot"))
        self.horizontalLayout_3.addWidget(self.fftPlot)
