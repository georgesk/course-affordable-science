...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "A1 ", None))
        self.checkBox_2.setText(_translate("MainWindow", "A2 ", None))
        self.checkBox_3.setText(_translate("MainWindow", "IN1", None))
        self.checkBox_4.setText(_translate("MainWindow", "IN2", None))
        self.checkBox_5.setText(_translate("MainWindow", "SEN", None))
        self.label.setText(_translate("MainWindow", "Samples:", None))
        self.samplesEdit.setText(_translate("MainWindow", "400", None))
