...
** Describing the new experiment
This experiment is not described in expEYES Junior's handbook, so let us
consider that it is "new". It is using a liquid potentiometer to record
...
#+NAME: fig:liquid_pot
[[./img/liquid_pot.png]]
*** Features in this experiment which require a special program
...
The file is available from our [[][repository]], as =oscill.ui=. You can download
it, and make a fewmodifications, like
- changing some part of the layout,
- changing the help tips associated with some widgets,
